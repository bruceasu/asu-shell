...
public class Console extends JFrame {
    ...
    private JPanel getCmdPanel() {
        if (cmdPanel == null) {
            ...
            cmdPanel.add(getJLabel(), BorderLayout.WEST);
...
//        setUndecorated(false);
                    ...
                    SwingUtilities.invokeLater(new Runnable() {
                        ...
                        public void run() {
                            if (fullScreenFlag) {
                                ...
                                GUITools.fullscreen(Console.this, fullScreenFlag);
                            } else {
                                fullScreenFlag = true;
    ...
    private JMenuItem autocodePDM;

    private JMenu autocode;

    private void cmdlineKeyKeyPressed(KeyEvent event) {
        // System.out.println(event.getKeyCode());
        if (event.getKeyCode() == 0x0d || event.getKeyCode() == 0x0a) {
            try {
