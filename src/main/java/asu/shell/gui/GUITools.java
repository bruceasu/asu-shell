...
public class GUITools
{
    ...
    public static KeyAdapter getKeyAdapter(final JTextComponent component, UndoManager um)
    {
        ...
        return new KeyAdapter()
        {
            ...
            {
                /*全选*/
                boolean isA = e.getKeyCode() == KeyEvent.VK_A;
                /* 复制 */
                boolean isC = e.getKeyCode() == KeyEvent.VK_C;
                /*剪切*/
                boolean isX = e.getKeyCode() == KeyEvent.VK_X;
                boolean isV = e.getKeyCode() == KeyEvent.VK_V;
                boolean isZ = e.getKeyCode() == KeyEvent.VK_Z;
                boolean isR = e.getKeyCode() == KeyEvent.VK_R;
                boolean isControlDown = e.isControlDown();
                boolean isHotKeys = isControlDown && (isA || isC || isX || isV || isZ || isR);
                if (!isHotKeys) {
                    return;
                }
                switch (e.getKeyCode()) {
                ...
                case KeyEvent.VK_V:
                    ...
                    if (content.isDataFlavorSupported(DataFlavor.stringFlavor)) {//判断是否为文本类型
                        ...
                        if (component instanceof JTextArea) {
                            ((JTextArea) component).replaceRange(text,
                ...
                case KeyEvent.VK_X:
                    ...
                    if (Strings.isBlank(selectedText2)) {
                        ...
                        if (component instanceof JTextArea) {
                            ((JTextArea) component).replaceRange("", component.getSelectionStart(),
    ...
    {
        String[] lafArray = new String[]{"com.alee.laf.WebLookAndFeel",
...
for (int i=0; i<gs.length; i++) {
    ...
    */
    static         GraphicsDevice        device    = GraphicsEnvironment.getLocalGraphicsEnvironment()
                                                                        .getScreenDevices()[0];
    private static Map<Frame, Rectangle> winStates = new HashMap<>();
